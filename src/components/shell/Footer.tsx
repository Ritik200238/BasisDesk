  ...
  return (
    <footer className="border-t border-border">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-1 px-4 py-6 text-micro text-muted">
        <p>
          Market data is read live from SoDEX mainnet; order execution runs on the SoDEX testnet
          sandbox, so no real funds move. Non-custodial: you sign every action with your own wallet,
          and keys never leave your device.
        </p>
        <p>
